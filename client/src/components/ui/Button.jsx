const base =
	'inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition transform focus:outline-none focus:ring-2 focus:ring-forest/40 dark:focus:ring-trail/40 disabled:opacity-60 disabled:cursor-not-allowed';
