...
const variants = {
	...
	secondary:
		'border border-soft/90 dark:border-white/12 bg-white/70 dark:bg-white/5 text-charcoal dark:text-sand backdrop-blur-md ' +
	...
	// Back-compat
	outline: 'border border-soft/90 dark:border-white/12 bg-white/70 dark:bg-white/5 text-charcoal dark:text-sand backdrop-blur-md hover:border-trail/60',
};
...
export default function Button({
	...
	return (
		...
		>
			...
			<span className={cn(loading ? 'opacity-90' : '')}>{props.children}</span>
		</Comp>
	);
}
