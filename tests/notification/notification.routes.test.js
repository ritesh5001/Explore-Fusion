...
describe('Notification service API', () => {
  it('lists notifications', async () => {
    const response = await agent.get('/api/v1/notifications').set('Accept', 'application/json');
  ...
  it('reads a notification by id', async () => {
    const response = await agent.get(`/api/v1/notifications/${sampleId}`);
  ...
  it('deletes a notification', async () => {
    const response = await agent.delete(`/api/v1/notifications/${sampleId}`);
